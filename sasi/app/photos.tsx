    ...
    <div id="gallery" className="relative w-full" data-carousel="slide">
      ...
      <div className="relative h-56 overflow-hidden rounded-lg md:h-96">
        ...
        <div className="hidden duration-700 ease-in-out" data-carousel-item>
          <img src="https://www.allbusiness.com/media-library/crowdfunding-concept.jpg?id=32093399" className="absolute block max-w-full h-auto -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="" />
        </div>
        {/* Item 2 */}
        <div className="hidden duration-700 ease-in-out" data-carousel-item="active">
          <img src="https://www.ionos.co.uk/startupguide/fileadmin/StartupGuide/Teaser/crowdfunding.jpg" className="absolute block max-w-full h-auto -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="" />
        </div>
        {/* Item 3 */}
        <div className="hidden duration-700 ease-in-out" data-carousel-item>
